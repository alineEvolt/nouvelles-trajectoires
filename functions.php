...
function nouvelles_trajectoires_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'nouvelles_trajectoires_custom_background_args', array(
 ...
 */
function nouvelles_trajectoires_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'nouvelles_trajectoires_content_width', 640 );
}
add_action( 'after_setup_theme', 'nouvelles_trajectoires_content_width', 0 );
...
function nouvelles_trajectoires_scripts() {
	...
	wp_enqueue_script( 'nouvelles-trajectoires-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'nouvelles-trajectoires-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
